...
import path, { join } from "path"; // Make sure to import path and join
...
const someConditionForLobbyReady = true;
if (someConditionForLobbyReady) {
    notifyLobbyReady();
}

// Export the app and client for testing
export { app, client };
